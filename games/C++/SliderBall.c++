/* APPROACH:
-Initialize the graphics environment and set the background color.
-Create sliders of different colors (red, green, and blue) with varying speeds.
-Generate colorful balls with random positions, velocities, and directions.
-Continuously update the positions of the sliders and balls while checking for collisions.
-Calculate the scores(penalty if collide with wrong slider) based on ball-slider collisions and display them.
